  ...
  return (
    <footer className="footer">
      <div className="container footer__main">
        ...
        <div><h2>Contato</h2><a href={siteConfig.contacts.founderInstagramUrl} target="_blank" rel="noreferrer"><Instagram aria-hidden="true" size={18} /> {siteConfig.contacts.founderInstagramUsername}</a><a href={`https://wa.me/55${siteConfig.contacts.whatsappRaw}`} target="_blank" rel="noreferrer"><MessageCircle aria-hidden="true" size={18} /> WhatsApp ABRIAT</a></div>
      </div>
